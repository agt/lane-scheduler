...
from scheduler import Lane, GPU_LANES, lane_for_gpu_class
from pod_translator import INHIBIT_TAINT_KEY, INHIBIT_TAINT_VALUE
...
class NodeInfo:
    ...
    def capacity(self) -> float:
        from scheduler import GPU_LANES as _GPU_LANES
