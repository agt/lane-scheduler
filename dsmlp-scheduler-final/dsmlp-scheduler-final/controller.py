...
from scheduler import Job, Lane, SchedulerConfig, Scheduler, initialise_lanes, lane_for_gpu_class
from course_registry import CourseRegistry
from node_capacity import NodeCapacityTracker
...
def discover_gpu_classes(core_v1: "client.CoreV1Api") -> list[str]:
    ...
    """
    from node_capacity import GPU_CLASS_TAINT_KEY
...
class DSMLPController:
    ...
    def _running_pod_from_pod(self, uid: str, pod: dict) -> Optional[RunningPod]:
        ...
        """
        from pod_translator import _is_batch, _resource_units, _gpu_lane
        ...
        from pod_translator import _resource_units as _ru
        units = _ru(pod, gpu_lane)

        job_stub = type("_J", (), {"batch": batch, "lane": gpu_lane})()
        from pod_translator import _gpu_lane as _gl
        lane = _gl(pod)
        from scheduler import Lane as _Lane
    ...
    def _upsert_running(self, uid: str, pod: dict) -> None:
        ...
        if rp is None:
            return
        from pod_translator import _gpu_lane, _is_batch
        from scheduler import Lane as _Lane, LANE_NAMES
        gpu_lane  = _gpu_lane(pod)
    ...
    def _build_wait_snapshot(self) -> dict[str, WaitEstimate]:
        ...
        """
        from scheduler import LANE_NAMES, Lane as _Lane
        from pod_translator import _is_batch
